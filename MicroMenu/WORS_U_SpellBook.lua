...
--WORS_U_SpellBook.frame:SetUserPlaced(false)
...
local closeBtn = WORS_U_SpellBookFrame.CloseButton
if closeBtn then
	closeBtn:ClearAllPoints()
	--closeBtn:SetPoint("TOPRIGHT", WORS_U_SpellBookFrame, "TOPRIGHT", 4, 4)
end
...
eventFrame:SetScript("OnEvent", function(self, event)
	if event == "PLAYER_ENTERING_WORLD" then
		...
		if pos then
			...
			WORS_U_SpellBook.frame:SetPoint("BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -20, 90)
			SaveFramePosition(WORS_U_SpellBook.frame)
		end	
