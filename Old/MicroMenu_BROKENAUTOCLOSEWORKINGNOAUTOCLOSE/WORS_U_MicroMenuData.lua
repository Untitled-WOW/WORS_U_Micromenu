...
WORS_U_SpellBook.spells = {
 ...
 -- {level = 4, name = "Enchant Crossbow Bolt (Opal)", id = nil, runes = {["Cosmic Rune"] = 1, ["Fire Rune"] = 1}},
    {level = 5, name = "Water Strike", id = 79535, runes = {["Water Rune"] = 1, ["Air Rune"] = 1, ["Mind Rune"] = 1}},
 ...
 -- {level = 7, name = "Enchant Crossbow Bolt (Sapphire)", id = nil, runes = {["Cosmic Rune"] = 1, ["Water Rune"] = 1}},
    {level = 9, name = "Earth Strike", id = 79540, runes = {["Earth Rune"] = 2, ["Air Rune"] = 1, ["Mind Rune"] = 1}},
    {level = 11, name = "Weaken", id = 99312, runes = {["Body Rune"] = 1, ["Earth Rune"] = 2, ["Water Rune"] = 3}},
    {level = 13, name = "Fire Strike", id = 79545, runes = {["Fire Rune"] = 3, ["Air Rune"] = 2, ["Mind Rune"] = 1}},
 -- {level = 14, name = "Enchant Crossbow Bolt (Jade)", id = nil, runes = {["Cosmic Rune"] = 1, ["Fire Rune"] = 1}},
    ...
    {level = 19, name = "Curse", id = 99314, runes = {["Body Rune"] = 1, ["Earth Rune"] = 3, ["Water Rune"] = 2}},
    {level = 20, name = "Bind", id = 99316, runes = {["Nature Rune"] = 2, ["Earth Rune"] = 3, ["Water Rune"] = 2}},
    {level = 21, name = "Low Level Alchemy", id = 114135, runes = {["Nature Rune"] = 1, ["Fire Rune"] = 3}, openInv = true},
    {level = 23, name = "Water Bolt", id = 79536, runes = {["Water Rune"] = 2, ["Air Rune"] = 2, ["Chaos Rune"] = 1}},
 -- {level = 24, name = "Enchant Crossbow Bolt (Pearl)", id = nil, runes = {["Cosmic Rune"] = 1, ["Water Rune"] = 1}},
    ...
    {level = 27, name = "Lvl-2 Enchant", id = 460023, runes = {["Cosmic Rune"] = 1, ["Air Rune"] = 3}, openInv = true},
 -- {level = 27, name = "Enchant Crossbow Bolt (Emerald)", id = nil, runes = {["Cosmic Rune"] = 1, ["Earth Rune"] = 1}},
    {level = 29, name = "Earth Bolt", id = 79541, runes = {["Earth Rune"] = 3, ["Air Rune"] = 2, ["Chaos Rune"] = 1}},
 -- {level = 29, name = "Enchant Crossbow Bolt (Red Topaz)", id = nil, runes = {["Cosmic Rune"] = 1, ["Fire Rune"] = 1}},
    ...
    {level = 35, name = "Fire Bolt", id = 79546, runes = {["Fire Rune"] = 4, ["Air Rune"] = 3, ["Chaos Rune"] = 1}},
 ...
 -- {level = 40, name = "Teleport to House", id = nil, runes = {["Law Rune"] = 1, ["Earth Rune"] = 1, ["Air Rune"] = 1}},
    ...
    {level = 47, name = "Water Blast", id = 79537, runes = {["Water Rune"] = 3, ["Air Rune"] = 3, ["Death Rune"] = 1}},
 ...
 -- {level = 50, name = "Iban Blast", id = nil, runes = {["Fire Rune"] = 5, ["Death Rune"] = 1}},
    {level = 50, name = "Snare", id = 99537, runes = {["Nature Rune"] = 4, ["Earth Rune"] = 4, ["Water Rune"] = 3}},
 -- {level = 50, name = "Magic Dart", id = nil, runes = {["Air Rune"] = 1, ["Death Rune"] = 1}},
    ...
    {level = 53, name = "Earth Blast", id = 79542, runes = {["Earth Rune"] = 4, ["Air Rune"] = 3, ["Death Rune"] = 1}},
 -- {level = 54, name = "Civitas illa Fortis Teleport", id = nil, runes = {["Law Rune"] = 2, ["Fire Rune"] = 2}},
    ...
    {level = 57, name = "Lvl-4 Enchant", id = 460025, runes = {["Cosmic Rune"] = 1, ["Earth Rune"] = 1}, openInv = true},
 -- {level = 57, name = "Enchant Crossbow Bolt (Diamond)", id = nil, runes = {["Cosmic Rune"] = 1, ["Earth Rune"] = 10}},
    ...
    {level = 59, name = "Fire Blast", id = 79547, runes = {["Fire Rune"] = 4, ["Air Rune"] = 3, ["Death Rune"] = 1}},
 ...
 -- {level = 66, name = "Vulnerability", id = nil, runes = {["Body Rune"] = 1, ["Earth Rune"] = 5, ["Water Rune"] = 5}},
    {level = 68, name = "Lvl-5 Enchant", id = 460026, runes = {["Cosmic Rune"] = 1, ["Water Rune"] = 15, ["Earth Rune"] = 15}, openInv = true},
 -- {level = 68, name = "Enchant Crossbow Bolt (Dragonstone)", id = nil, runes = {["Cosmic Rune"] = 1, ["Earth Rune"] = 15}},
    {level = 70, name = "Earth Wave", id = 79543, runes = {["Earth Rune"] = 7, ["Air Rune"] = 5, ["Blood Rune"] = 1}},
 ...
 -- {level = 74, name = "Teleother Lumbridge", id = nil, runes = {["Law Rune"] = 1, ["Soul Rune"] = 1, ["Earth Rune"] = 1}},
    {level = 75, name = "Fire Wave", id = 79548, runes = {["Fire Rune"] = 7, ["Air Rune"] = 5, ["Blood Rune"] = 1}},
    {level = 79, name = "Entangle", id = 99315, runes = {["Nature Rune"] = 4, ["Earth Rune"] = 5, ["Water Rune"] = 5}},
...
WORS_U_SpellBook.runeInfo = {
	...
	["Unpowered Orb"] = { itemID = 90529, staffIDs = {} },
}
...
WORS_U_PrayBook.prayers = {
    ...
    {level = 19, id = 80019, buffIcon = "Interface\\Icons\\active_rapidrestore.blp"},    -- Rapid Restore  CHANGE TO RESTORE CURRENTLY DOUBLE HEAL
