...
WORS_U_PrayBook.prayers = {
    {level = 1, id = 79502},  -- Thick Skin
    {level = 4, id = 79506},  -- Burst of Strength
    {level = 7, id = 79508},  -- Clarity of Thought
    {level = 8, id = 79512},  -- Sharp Eye
    {level = 9, id = 79514},  -- Mystic Will
    {level = 10, id = 79503},  -- Rock Skin
    {level = 13, id = 79505},  -- Superhuman Strength
    {level = 16, id = 79509},  -- Improved Reflexes
    -- {level = 19, id = nil},    -- Rapid Restore
    {level = 22, id = 79521},    -- Rapid Heal
...
local function GetLevelFromReputation(repValue)
    -- Adjust reputation to match XP by adding 43000
    local adjustedXP = repValue - 43000

    -- Determine the level by finding the highest level for which XP is <= adjustedXP
    ...
    -- Return level 1 if reputation is below the first XP threshold
    return 1
end
...
WORS_U_PrayBook.frame:SetSize(190, 260)  -- Adjust height based on the number of buttons
...
for i, prayerData in ipairs(WORS_U_PrayBook.prayers) do
    ...
    prayerButton:SetPoint("TOPLEFT", padding + (buttonSize + padding) * column, -padding - (buttonSize + padding) * row)
