...
local magicLevel = 1
local magicButtons = {}  -- Table to hold button references for clearing/re-creation
...
local function SetupMagicButtons()
    ...
    wipe(magicButtons)  -- Clear the table to avoid duplicates
    ...
    for i, spellData in ipairs(WORS_U_SpellBook.spells) do
        ...
        if magicLevel < requiredLevel then
            ...
            spellButton:SetAlpha(0.5)  -- Reduce transparency
        else
        ...
        table.insert(magicButtons, spellButton)  -- Add button to magicButtons table
    end
end
